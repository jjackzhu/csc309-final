...
from subscriptions.views import AddUserCard, DeleteUserPlan, EditUserCard, \
    UpdateUserCardRedirect, UpdateUserPlanRedirect, UserAddPlan, SubListView, \
    UserCardView, \
    UserEditPlan, UserPaymentsView, \
    UserPlanView
...
urlpatterns = [
    ...
    path('my_plan/update/', UpdateUserPlanRedirect.as_view(), name='update_plan_redirect'),
    path('my_card/', UserCardView.as_view(), name='user_card'),
    path('my_card/update/', UpdateUserCardRedirect.as_view(), name='update_card_redirect'),
